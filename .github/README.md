...
[`@aws-sdk/client-opensearch`](https://www.npmjs.com/package/@aws-sdk/client-opensearch/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearch@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d2A7XK/Y8WEU68ogskeNPoWfDSKRiicWuUTfCjOAs0tpMm74wabyc4r2gDyJTXKY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-opensearch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearch@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearch@3.94.0/index.min.mjs": "sha384-d2A7XK/Y8WEU68ogskeNPoWfDSKRiicWuUTfCjOAs0tpMm74wabyc4r2gDyJTXKY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-opensearch/blob/refs/tags/3.94.0/LICENSE
```
