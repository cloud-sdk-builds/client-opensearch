...
[`@aws-sdk/client-opensearch`](https://www.npmjs.com/package/@aws-sdk/client-opensearch/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearch@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bUa4crWw9Thf+Zlnx/nxOkmvuahr0LbSGBUtHMXxf5hJ2VyUyiNMuDkNfH+qxQni
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-opensearch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearch@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearch@3.264.0/index.min.mjs": "sha384-bUa4crWw9Thf+Zlnx/nxOkmvuahr0LbSGBUtHMXxf5hJ2VyUyiNMuDkNfH+qxQni"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-opensearch/blob/refs/tags/3.264.0/LICENSE
```
